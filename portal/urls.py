...
urlpatterns = [
    ...
    path('app/tasks/<int:pk>/authorise/', views.task_authorise, name='task-authorise'),
    path('app/tasks/<int:pk>/decline/', views.task_decline, name='task-decline'),
    path('app/tasks/<int:pk>/request-auth/', views.task_request_auth, name='task-request-auth'),
